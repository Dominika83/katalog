    ...
    <section id="about">
        <div class="container">
            <div class="about_title">
                <h1><?php the_field('tytul_regulamin'); ?></h1>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <p><?php the_field('opis1_regulamin'); ?></p>
                    <p><?php the_field('opis2_regulamin'); ?></p>
                    <p><?php the_field('opis3_regulamin'); ?></p>
                    <p><?php the_field('opis4_regulamin'); ?></p>
                </div>
            </div>
        </div>
    </section>
